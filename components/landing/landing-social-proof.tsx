...
const TESTIMONIALS = [
  {
    quote: "인디 뮤지션 2,400명이 이미 앨범 홍보에 사용 중입니다",
    author: "maestro stats",
  },
  {
    quote: "캔버스 하나로 스트리밍 체류 시간이 눈에 띄게 늘었어요.",
    author: "bedroom producer · 서울",
  },
  {
    quote: "숏폼 업로드 전에 10초면 비주얼이 끝납니다. 진짜 치트키.",
        ...
        <SectionReveal>
          ...
          <ul className="mt-8 space-y-5 sm:mt-10 sm:space-y-6">
            {DELIVERABLES.map((item) => (
              ...
              >
                <span className="text-cyan-500/90" aria-hidden>
                  ✓
                </span>
                {item}
              </li>
          ...
          <div className="mt-8 space-y-4 sm:mt-10 sm:space-y-5">
            {TESTIMONIALS.map((t, i) => (
              <blockquote
                ...
                className={
                  i === 0
                    ? "border border-cyan-500/30 bg-cyan-950/20 px-5 py-4 sm:px-6 sm:py-5"
