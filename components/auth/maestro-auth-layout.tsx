...
export const authInputClassName =
  "rounded-none border-zinc-700 bg-black/40 py-6 text-zinc-100 shadow-none placeholder:text-zinc-500 focus-visible:border-cyan-500/50 focus-visible:ring-cyan-500/20"
        ...
        <div className="w-full max-w-md">
          <div className="mb-8 flex flex-col items-center text-center">
            <div className="mb-5 flex h-20 w-20 items-center justify-center rounded-2xl border border-zinc-700 bg-zinc-900/50 shadow-sm">
              <Music className="h-10 w-10 text-cyan-400" strokeWidth={1.25} />
            </div>
            <h1
          ...
          <div className="mt-4 flex items-center justify-center gap-2 text-xs text-zinc-500">
            <Link
              href="/terms"
              className="text-cyan-500/90 hover:text-cyan-400 hover:underline"
            >
              이용약관
            </Link>
